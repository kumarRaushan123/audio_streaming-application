...
//get a list of installed apps.
    ...
    public void fmradio(View view) {
        try {
            ...
            radio_not(MainAc.this);
        }
    }

    public void change(View view) {
        Intent intent = new Intent(MainAc.this, PlayerActivity.class);
        startActivity(intent);
        overridePendingTransition(R.anim.pull_in_right,R.anim.push_out_left);
    }
    ...
    public void radio_not(MainAc view) {
        AlertDialog.Builder mbulider = new AlertDialog.Builder(MainAc.this);
