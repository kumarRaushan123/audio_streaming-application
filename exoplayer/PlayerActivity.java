...
//get a list of installed apps.
    ...
    public void alert(PlayerActivity view){
        AlertDialog.Builder mbulider=new AlertDialog.Builder(PlayerActivity.this);
        View mview = getLayoutInflater().inflate(R.layout.alert_dailog,null);
        ...
        textView3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Toast.makeText(PlayerActivity.this, "Listen via Radio", Toast.LENGTH_SHORT).show();
    ...
    public  void netw(View view){
        Intent intent=new Intent(PlayerActivity.this,Netwo.class);
        startActivity(intent);
    }
    public void fmradio(View view) {
        try {
            ...
            radio_not(PlayerActivity.this);
        }
    }
    public void radio_not(PlayerActivity view) {
        AlertDialog.Builder mbulider = new AlertDialog.Builder(PlayerActivity.this);
        View mview = getLayoutInflater().inflate(R.layout.radio_not, null);
  ...
  public void onStop() {
    ...
    public void server(PlayerActivity view){
        AlertDialog.Builder mbulider=new AlertDialog.Builder(PlayerActivity.this);
        View mview = getLayoutInflater().inflate(R.layout.server_not,null);
                final TextView textView1=(TextView)mview.findViewById(R.id.set1);
                final TextView textView2=(TextView)mview.findViewById(R.id.textView2);
        textView1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(PlayerActivity.this,MainAc.class);
                startActivity(intent);
                overridePendingTransition(R.anim.pull_in_right,R.anim.push_out_left);
            }
        });
